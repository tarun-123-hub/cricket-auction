  ...
  return (
    <div className="bg-gray-900/80 backdrop-blur-xl rounded-2xl p-6 border border-blue-500/30 h-full shadow-xl">
          ...
          >
            <div className="text-center">
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-300 text-lg">Remaining Budget</p>
              </div>
              ...
              <div className="flex justify-center items-center space-x-6 text-sm">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-300">
                    {formatCurrency(10000000 - (teamArray[activeTeamIndex]?.purse || 0))} Spent
                  </span>
                </div>
              </div>
            </div>
      ...
      <div className="space-y-3">
        <h4 className="text-lg font-semibold text-gray-300 mb-3">All Teams</h4>
          ...
          >
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-gray-400">
                {formatCurrency(10000000 - (team.purse || 0))} spent
              </p>
            </div>
          </motion.div>
        ))}
